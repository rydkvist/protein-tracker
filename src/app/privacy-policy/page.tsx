export default function Page() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Rydkvist Consulting AB, Stockholm, 11234.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Protein Tracker, accessible from{" "}
            <a
              href="https://protein-tracker.rydkvist.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://protein-tracker.rydkvist.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: niklas@rydkvist.com</li>
      </ul>
    </>
  );
}
